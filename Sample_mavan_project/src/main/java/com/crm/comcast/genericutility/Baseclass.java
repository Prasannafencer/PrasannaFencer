...
public class Baseclass {
	...
	public Excel_utility elib=new Excel_utility();
		@BeforeSuite(groups = {"smoketesting","regresiontesting"})
	public void TITLE_OF_THE_PAGE()
	{
		System.out.println("Start the suit execution");	
	}
		
	@BeforeClass(groups = {"smoketesting","regresiontesting"})
	public void lunchbrowsr()
	{
		 		
     driver=new ChromeDriver();	
		
	}
	@BeforeMethod(groups = {"smoketesting","regresiontesting"})
